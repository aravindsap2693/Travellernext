...
const CustomNavbar: React.FC<CustomNavbarProps> = ({
  ...
  return (
    <Navbar
      {...props}
      style={toggleMode ? styles.navbar : styles.darkNavbar}
    >
      <Navbar.Brand href="#">
      ...
      <>
        {!expanded && windowWidth >= 767 ? (
          <>
            ...
            <Nav pullRight>
              <Nav.Item icon={toggleMode ?<DoingRoundIcon  style={{color:"yellow"}}/>: <DoingRoundIcon  style={{color:"white"}}/>} onClick={onToggleMode}>
